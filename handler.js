...
//this.reply(m.chat, `𝘕𝘖 𝘛𝘐𝘌𝘕𝘌 𝘙𝘈𝘎𝘕𝘈𝘊𝘖𝘐𝘕𝘚`, m)
this.sendMessage(m.chat, {text: `𝘕𝘖 𝘛𝘐𝘌𝘕𝘌 𝘙𝘈𝘎𝘕𝘈𝘊𝘖𝘐𝘕𝘚`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' RagnaBot ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
...
if (m.money)
m.reply(+m.money + ' 𝚁𝙰𝙶𝙽𝙰𝙲𝙾𝙸𝙽𝚂 𝙶𝙰𝚂𝚃𝙰𝙳𝙾(𝚂)')  
break
}}} catch (e) {
console.error(e)
} finally {
...
"mediaType": 1, 
sourceUrl: 'https://chat.whatsapp.com/GOQBEelnmES4pXdlZbs6EP' }}}, { quoted: fkontak2 })
apii.data = ''
